...
👉 [ghcr.io/FoveaParis/test4](https://ghcr.io/FoveaParis/test4) 🐳
...
#| eval: false
docker run -it ghcr.io/FoveaParis/test4:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/FoveaParis/test4:devel
```
...
#| eval: false
git clone git@github.com:FoveaParis/test4.git && cd FoveaParis/test4
